		...
		<div class="container">
			<div class="row">
				<div class="col-lg-9">
					...
					<p class="sample-text text-justify">
                    Over the past 6 years Rectus has built a highly effective and successful Competency Assurance Management System (CAMS) that has been used to develop and train less competent employees for many industries including Oil and Gas.
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-9">
					...
					<p class="sample-text text-justify">
                        Rectus works with clients to help identify issues and solve problems using a systematic and creative approach.

                        Rectus involvement varies with the nature of the situation and the request of the client. In particular, the assignment may range from ad hoc advice on a particular problem or issue, to the design of comprehensive systems for the client as well as the evaluation and revision of existing systems.
