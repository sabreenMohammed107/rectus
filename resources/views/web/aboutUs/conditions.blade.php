		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					<h1 class="text-white">Training Course</h1><h2 style="color:#32a2a8">Registration
Terms & Conditions
</h2>
				</div>
			</div>
			...
			<div class="row" >
				<div class="col-lg-8 event-details-right"style="background-color:#F5F5DC">
					<div class="single-event-details"style="background-color:#F5F5DC">
						<h4 style="border-bottom:solid #32a2a8;padding-bottom:10px;margin-bottom:30px">Registration
Terms & Conditions
</h4>
						<div>
						...
						<div>
							...
							<ul class="list-links  div-scroll" style="list-style:square">
								...
								<li><p>	Course fees are payable upon receiving confirmation & Invoice from Rectus unless a valid, authorized Purchase Order is provided and accepted.</p></li>
						...
						<div>
							...
							<ul class="list-links  div-scroll" style="list-style:square">
								<li><p>	It may be necessary for Rectus to amend or cancel any course, course times, instructors, and dates or published fees due to unforeseen circumstances and we reserve the right for such changes.</p></li>
						...
						<div>
							...
							<ul class="list-links  div-scroll" style="list-style:square">
								...
								<li><p>	Please report any foreseeable absences to a Rectus Instructor representative or to your sponsors directly.</p></li>
