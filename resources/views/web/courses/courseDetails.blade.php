...
<div class="social-side">
	<button class="activate"><span><i class="fa fa-share"></i><br>SHARE</span></button>
<button class="HideBtn" style="display:none"><span><i class="fa fa-reply"></i><br>HIDE</span></button>
	<div id="target">
                            <?php
            ...
            <div class="col-lg-6 event-details-left left-contents">
                ...
                <div class="accordion-left">
                    ...
                    <dl class="accordion collapsable">
                        ...
                        @else
                        <dt class="active" style="font-weight: bold;">
                            <a  class="active" href="">Course Description</a>
                        </dt>
