		...
		<div class="row">
			<div class="col-lg-4 d-flex flex-column address-wrap">
				<div class="single-contact-address d-flex flex-row">
					<div class="icon">
						<span class="lnr lnr-home" style="color:#32a2a8"></span>
					</div>
				...
				<div class="single-contact-address d-flex flex-row">
					<div class="icon">
						<span class="lnr lnr-envelope" style="color:#32a2a8"></span>
					</div>
					<div class="contact-details">
						<h5> {{ $branch->email}}</h5>
						<p><a href="{{ route('contactus') }}" style="color:#32a2a8">Contact Us </a> anytime!</p>
					</div>
				</div>
			</div>
			<div class="col-lg-8">
					...
					<div class="single-footer-widget">
						...
						<div class="footer-bottom">
							...
							<a href="https://www.facebook.com/BTSforTraining/?mibextid=ZbWKwL" target="_blank" ><i class="fab fa-facebook-f"></i></a>
								...
								<a href="https://wa.me/971-547049500" target="_blank"><i class="fab fa-whatsapp"></i></a>
