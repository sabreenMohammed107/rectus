				...
				<div class="col-sm-12">
					...
					<div class="col-lg-3 col-md-4 col-sm-12">
						...
						<ul class="nav nav-tabs tabs-left sideways list-group">
							...
							<li class="active"><a href="{{ url('technicalTraining/'.$techId) }}" data-toggle="tab">LEADERSHIP AND PROFESSIONAL GROWTH</a></li>
							<li><a href="{{ url('softTraining/'.$soft) }}" data-toggle="tab">TALENT MANAGEMENT AND ORGANIZATIONAL DEVELOPMENT</a></li>
