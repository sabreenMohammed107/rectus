				...
				<div class="search-section-padding">
					<form  action="{{route('searchForm')}}" class="search-area">
						...
						<div class="row form-group">
							...
							<div class="col-md-3" style="margin:0px 5px 10px 0px">
								<input type="submit" value="Search" class="form-control btn text-uppercase" style="background-color:#32a2a8;color:#fff;" />
							</div>
						</div>
					</form>
				</div>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 single-blog">
				...
				@if($round->course->course_sub_category_id==4)
					<h5 style="border:none; padding-bottom:30px;text-align:right">{{ Str::limit($round->course->course_en_name, 110,'') }}</h5>
                       @else
                        <h5 style="border:none; padding-bottom:30px;">{{ Str::limit($round->course->course_en_name, 70,'') }}</h5>
                          @endif
				         </a>
                          </p>
