...
class RoundController extends Controller
{
    ...
    public function index()
    {
        ...
        $rounds = Round::orderBy("created_at", "Desc")->paginate(150);


        //  $rounds= DB::table('rounds')->get();
        // $rounds=Round::orderBy("created_at", "Desc")->get();
        // $rounds=Round::chunk(50, function($inspectors) {
        //     foreach ($inspectors as $inspector) {
        //         // apply some action to the chunked results here
        //     }});

        // $rounds=$rounds->chunk(500);
        // $rounds=collect($round)->chunk(700);
        // return($rounds);
    ...
    function fetchRound(Request $request)
    {
        ...
        return view($this->viewName . 'preIndex', compact('rounds','name'))->render();
    }
